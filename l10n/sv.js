OC.L10N.register(
    ...
    "Organization Folders are Team Folders (formerly Group Folders) designed for large organizations, with permissions managed via an intuitive web interface.\n\n**This app is currently released as a beta! It's stable, but not yet feature-complete.**\n\n\nTo install follow these instructions: https://github.com/verdigado/organization_folders?tab=readme-ov-file#how-to-install \n\n\n**Features**:\n  - ✨ No need to create ACL rules manually anymore\n  - 🔐 Fine-grained management rights delegation support\n  - 🔧 Management in the web interface and using occ commands\n  - 🏢 Support for adding your organizations structure/hierarchy, to allow roles within them to be picked in a structured and intuitive way" : "Organisationsmappar är Teammappar (tidigare Gruppmappar) utformade för stora organisationer, med behörigheter som hanteras via ett intuitivt webbgränssnitt.\n\n**Den här appen är för närvarande släppt som en beta! Den är stabil, men ännu inte funktionskomplett.**\n\n\nFör att installera, följ dessa instruktioner: https://github.com/verdigado/organization_folders?tab=readme-ov-file#how-to-install \n\n\n**Funktioner**:\n  - ✨ Ingen anledning att skapa ACL-regler manuellt längre\n  - 🔐 Stöd för finmaskig delegering av hanteringsrättigheter\n  - 🔧 Hantering i webbgränssnitt och med hjälp av occ-kommandon\n  - 🏢 Stöd för att lägga till din organisations struktur/hierarki, så att roller inom den kan väljas på ett strukturerat och intuitivt sätt",
