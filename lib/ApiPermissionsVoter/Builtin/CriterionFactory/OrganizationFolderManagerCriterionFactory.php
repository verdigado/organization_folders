...
class OrganizationFolderManagerCriterionFactory extends CriterionFactory {

	/** @var array<string, array<int, OrganizationFolderManagerCriterion>> */
	private array $cache = [];
	...
	public function build(Principal $principal, int $organizationFolderId): OrganizationFolderManagerCriterion {
		...
		return $this->cache[$principalKey][$organizationFolderId] = new OrganizationFolderManagerCriterion(
			$this->l10n,
